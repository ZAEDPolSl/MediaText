...
def default_evaluation_params():
    ...
    return {
                ...
                'GT_SAMPLE_NAME_2_ID':'gt_(\w+.*).txt', #TODO: ADD _img
                'DET_SAMPLE_NAME_2_ID':'res_(\w+.*).txt', #TODO: ADD _img
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    for noFile, resFile in enumerate(gt):
        print(f"Processing {noFile}")
...
if __name__=='__main__':
    #p={
    #  "g": "/workspaces/yolaphd/output/final_dataset/test/PanPP/metrics/gt.zip",
    #  "s": "/workspaces/yolaphd/output/final_dataset/test/PanPP/predictions.zip"
    #}
    p=None
    # p={
    #    "g": "/workspaces/yolaphd/text-detection-comparator/scripts/protocols/TIoU/ic15/gt.zip",
    #    "s": "/workspaces/yolaphd/text-detection-comparator/scripts/protocols/TIoU/ic15/pixellinkch4.zip"
    # }
    res_dict =  rrc_evaluation_funcs.main_evaluation(p,default_evaluation_params,validate_data,evaluate_method)
    print(res_dict)